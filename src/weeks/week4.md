...
5. Select the drl 0.800mm and drl 1mm files and add in drilling operations for each one with the corn bit, set the end
   depths according to
   the layer names and enable ramping. Set a return / pull-back distance to about 0.75 mm, to smooth things out.

6. Select the Edge_Cuts layer and add a new contour operation with the 30° engraving tool, set to 1.6mm, or a value
